...
#include "errandbot_planning/dijkstra_planner.hpp"

namespace errandbot_planning
{
...
PLUGINLIB_EXPORT_CLASS(errandbot_planning::DijkstraPlanner, nav2_core::GlobalPlanner)