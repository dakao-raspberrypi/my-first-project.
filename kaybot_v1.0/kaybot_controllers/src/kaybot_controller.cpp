#include "kaybot_controllers/kaybot_controller.hpp"

namespace kaybot_controller {

KaybotController::KaybotController(): controller_interface::ControllerInterface() {}

controller_interface::CallbackReturn KaybotController::on_init()
{
...
controller_interface::CallbackReturn KaybotController::on_configure
...
controller_interface::InterfaceConfiguration KaybotController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration KaybotController::state_interface_configuration() const
{
    controller_interface::InterfaceConfiguration config;
    config.type = controller_interface::interface_configuration_type::INDIVIDUAL;
    config.names.reserve(joint_names_.size());
...
controller_interface::CallbackReturn KaybotController::on_activate
    (const rclcpp_lifecycle::State & previous_state)
{
    (void)previous_state;
    appCommand_.clear();
...
controller_interface::return_type KaybotController::update
...
PLUGINLIB_EXPORT_CLASS(kaybot_controller::KaybotController, controller_interface::ControllerInterface)