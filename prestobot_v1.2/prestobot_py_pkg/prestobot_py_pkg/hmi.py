...
class HmiNode(Node):
    def __init__(self):
        ...
        self.home0_pose_ = self.create_pose_stamped(self.navigator_, 0.0, 0.0, 0.0)
        self.room1_pose_ = self.create_pose_stamped(self.navigator_, 5.5, 0.0, -1.57)
        self.room2_pose_ = self.create_pose_stamped(self.navigator_, 9.5, 0.0, -1.57)
